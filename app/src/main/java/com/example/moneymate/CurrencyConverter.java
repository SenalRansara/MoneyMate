...
public class CurrencyConverter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        convertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Double amountToConvert = Double.valueOf(CurrencyConverter.this.amountToConvert.getText().toString());
    ...
    public String getConversionRate(String convertFrom, String convertTo, Double amountToConvert) {
        ...
        String url = "https://free.currconv.com/api/v7/convert?q="+convertFrom+"_"+convertTo+"&compact=ultra&apiKey=da815e3500e835320572";
